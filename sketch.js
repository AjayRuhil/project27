...
function preload()
{
	bg=loadImage("Untitled1.png");
}

function setup() {
	var canvas = createCanvas(1260, 630);
	...
	roof = new Roof(width/2, height/4+20, 250, 15);
...
if (keyCode === RIGHT_ARROW) 
	{ Matter.Body.applyForce(bob5.body,bob5.body.position,{x:55,y:45});
	Matter.Body.applyForce(bob4.body,bob4.body.position,{x:55,y:45}); } 

if (keyCode === LEFT_ARROW) 
	{ Matter.Body.applyForce(bob2.body,bob2.body.position,{x:-55,y:-45});
	Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-55,y:-45}); } 
} 
